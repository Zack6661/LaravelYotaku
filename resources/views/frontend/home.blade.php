                        ...
                        @foreach ($data['new_categories'] as $category)
                            <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                                <div class="categories__item set-bg"
                                    ...
                                    <div class="categories__text">
                                        <h4 style="background-color:white;">{{ $category->name }}</h4>
                                        <p style="background-color:white;">{{ $category->Products()->count() }} item</p>
                                        <a href="#">Jelajahi</a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row property__gallery">
                @foreach ($data['new_categories'] as $new_categories2)
                    @foreach ($new_categories2->Products()->limit(9)->get()
        as $product)
