<?php $__env->startSection('content'); ?>
    ...
    <section class="checkout spad">
        <div class="container">
            <form action="<?php echo e(route('checkout.process')); ?>" class="checkout__form" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="checkout__form__input">
                                    ...
                                    <input type="text" name="recipient_name" value="<?php echo e(auth()->user()->name); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="checkout__form__input">
                                ...
                                <div class="checkout__form__input">
                                    ...
                                    <select name="province_id" id="province_id" class="select-2" required>
                                        ...
                                        <?php $__currentLoopData = $data['provinces']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($province['province']); ?>" data-id="<?php echo e($province['province_id']); ?>"><?php echo e($province['province']); ?>
                            ...
                            <div class="checkout__order__product">
                                <ul>
                                    ...
                                    <?php $__currentLoopData = $data['carts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><?php echo e($loop->iteration); ?>. <?php echo e($cart->Product->name); ?> x
                                            <?php echo e($cart->qty); ?><span><?php echo e(rupiah($cart->total_price_per_product)); ?></span>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <span class="top__text">Total Weight</span>
                                        <span class="top__text__right"><?php echo e($data['carts']->sum('total_weight_per_product') / 1000); ?> Kg</span>
                                        <input type="hidden" name="total_weight" id="total_weight" value="<?php echo e($data['carts']->sum('total_weight_per_product')); ?>">
                                    </li>
                                </ul>
                            </div>
                            <div class="checkout__order__total">
                                <ul>
                                    <li>Subtotal <span><?php echo e(rupiah($data['carts']->sum('total_price_per_product'))); ?></span>
                                    </li>
                                    <li>Shipping Cost <span id="text-cost">Rp 0</span></li>
                                    <li>Total <span id="total"><?php echo e(rupiah($data['carts']->sum('total_price_per_product'))); ?></span></li>
...
<?php $__env->startPush('js'); ?>
    <script>
        function checkCost() {
            var origin = '<?php echo e($data["shipping_address"]->city_id); ?>';
            var destination = $('#city_id option:selected').data('id');
            var weight = "<?php echo e($data['carts']->sum('total_weight_per_product')); ?>";
        ...
        {
            var subtotal = `<?php echo e($data['carts']->sum('total_price_per_product')); ?>`;
...
<?php echo $__env->make('layouts.frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fawwazhe/yotakushop.my.id/resources/views/frontend/checkout/index.blade.php ENDPATH**/ ?>