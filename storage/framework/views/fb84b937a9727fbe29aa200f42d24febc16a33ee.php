        ...
        <div class="col-md-12">
            <?php $__env->startComponent('components.backend.card.card-table'); ?>
                <?php $__env->slot('header'); ?>
                    <h4 class="card-title"><?php echo e(__('text.list')); ?> <?php echo e(__('menu.product')); ?> <?php echo e($data['category']->name); ?></h4>
                    <div class="card-header-action">
                        <a href="<?php echo e(route('master.category.index')); ?>" class="btn btn-primary"><?php echo e(__('button.back')); ?></a>
                    </div>
                <?php $__env->endSlot(); ?>
                ...
                <?php $__env->slot('tbody'); ?>
                    <?php $__currentLoopData = $data['category']->Products()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
...
<?php echo $__env->make('layouts.backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fawwazhe/yotakushop.my.id/resources/views/backend/master/category/show.blade.php ENDPATH**/ ?>